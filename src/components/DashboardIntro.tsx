  ...
  useEffect(() => {
    ...
    const animate = (time: number) => {
      ...
      rings.forEach(r => {
        ...
        ctx.strokeStyle = `rgba(${BLUE_RGB}, ${r.alpha * (0.4 + pulse * 0.6)})`;
        ctx.lineWidth = 1.5;
        ctx.stroke();
      });
      ...
      for (let i = 0; i < dots.length; i++) {
        for (let j = i + 1; j < dots.length; j++) {
          ...
          if (dist < 150) {
            ...
            ctx.strokeStyle = `rgba(${BLUE_RGB}, ${a})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
      ...
      dots.forEach(d => {
        ...
        ctx.fillStyle = `rgba(${BLUE_RGB}, ${d.alpha * flicker})`;
        ctx.fill();
        ctx.beginPath();
        ctx.arc(d.x, d.y, d.r * 2.5, 0, Math.PI * 2);
        ctx.fillStyle = `rgba(${BLUE_RGB}, ${d.alpha * flicker * 0.15})`;
        ctx.fill();
      });
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-12">
        ...
        <motion.div
          ...
          style={{
            background: [
              "radial-gradient(circle at 40% 35%, rgba(255,255,255,0.15) 0%, rgba(30,58,95,0.06) 30%, rgba(30,58,95,0.01) 70%, transparent 100%)",
            ].join(""),
            boxShadow: [
              "0 0 60px rgba(30,58,95,0.08)",
              "0 0 120px rgba(30,58,95,0.04)",
              "inset 0 0 40px rgba(30,58,95,0.03)",
            ].join(","),
          }}
        ...
        >
          ...
          <motion.div
            ...
            style={{ border: "1.5px solid rgba(30,58,95,0.08)" }}
            animate={{ rotate: -360 }}
          ...
          <motion.div
            ...
            style={{ background: "radial-gradient(circle, rgba(30,58,95,0.08) 0%, transparent 60%)" }}
            animate={{
              boxShadow: [
                "0 0 30px rgba(30,58,95,0.06), 0 0 60px rgba(30,58,95,0.03)",
                "0 0 60px rgba(30,58,95,0.15), 0 0 120px rgba(30,58,95,0.08)",
                "0 0 30px rgba(30,58,95,0.06), 0 0 60px rgba(30,58,95,0.03)",
              ],
            }}
          ...
          >
            <path d="M10 3v14M5 12l5 5 5-5" stroke={`rgba(${BLUE_RGB}, 0.35)`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </motion.svg>
        </motion.div>
