            ...
            >
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "0 4px 24px rgba(58,90,122,0.04), 0 1px 0 rgba(212,175,55,0.06) inset",
                }}
                whileHover={{
                  scale: 1.02,
                  borderColor: "rgba(212,175,55,0.3)",
                  boxShadow: "0 8px 40px rgba(58,90,122,0.08), 0 0 60px rgba(212,175,55,0.04)",
              ...
              >
                ...
                <div className="flex items-center justify-center gap-4 mb-4">
                  <motion.div className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0"
                    style={{ background: "linear-gradient(135deg, rgba(212,175,55,0.12), rgba(227,240,250,0.2))", border: "1px solid rgba(212,175,55,0.12)", color: "#3A5A7A" }}
                    whileHover={{ scale: 1.2, rotate: 5, borderColor: "rgba(212,175,55,0.3)" }}
                  >
                    {ev.icon}
                  </motion.div>

                  <div className="text-left flex-1">
                    <span className="text-[10px] tracking-[0.3em] font-[var(--font-cinzel)]" style={{ color: "rgba(212,175,55,0.6)" }}>
                      {ev.time}
                    </span>
